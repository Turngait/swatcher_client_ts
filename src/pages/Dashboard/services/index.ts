...
export async function getInitData(token: string, period: string): Promise<{user: IUserData | null, status: number, stat: [any] | [] | null, foods: {foods: {publicFoods: IFood[] | []}, ingredients: any[]}, health: {illnesses: IIllness[] | null}}> {
